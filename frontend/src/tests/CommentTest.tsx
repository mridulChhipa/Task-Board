...
export const mockThread: ThreadDTO = {
  ...
  content:
    "The legacy dashboard is getting harder to maintain. I'm proposing we take two sprints to incrementally migrate it to TypeScript. Thoughts?",
  authorId: 101, // Alice
  isDeleted: false,
...
export const mockAllComments: Record<string, CommentDTO> = {
  c1: {
    id: 'c1',
    content:
      'I totally agree. We spend way too much time debugging runtime type errors.',
  ...
  'c1-1-1': {
    id: 'c1-1-1',
    content:
      "Strict mode from day one, otherwise we'll just end up with a sea of `any` types.",
    threadId: 'thread-ts-migration',
    authorId: 101, // Alice
    isDeleted: false,
    parentId: 'c1-1',
  ...
  'c1-2': {
    id: 'c1-2',
    content:
      'We should also set up ESLint rules to enforce typing alongside it.',
    threadId: 'thread-ts-migration',
    authorId: 104, // Dave
    isDeleted: false,
    parentId: 'c1',
  ...
  'c2-1-1': {
    id: 'c2-1-1',
    content:
      'Nevermind the above deleted comment, I just checked the roadmap and we have a buffer in Q2.',
    threadId: 'thread-ts-migration',
    authorId: 101, // Alice
    isDeleted: false,
  ...
  c3: {
    id: 'c3',
    content:
      "I'll create a Jira epic to track the individual component migrations.",
    threadId: 'thread-ts-migration',
    authorId: 103, // Charlie
    isDeleted: false,
    parentId: null,
...
export function CommentTest() {
  return <Thread thread={mockThread} allComments={mockAllComments} />;
}
