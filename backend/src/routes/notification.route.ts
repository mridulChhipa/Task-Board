...
notificationRouter.get("/:nid", authorizeNotificationOwner(), (req, res, next) => {
  notificationController.fetchNotification(req, res, next);
});

notificationRouter.delete("/:nid", authorizeNotificationOwner(), (req, res, next) => {
  notificationController.deleteNotification(req, res, next);
});

notificationRouter.patch("/:nid", authorizeNotificationOwner(), (req, res, next) => {
