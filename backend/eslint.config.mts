    ...
    rules: {
      "no-restricted-syntax": [
        ...
        },
        {
          ...
          message: "Do not use mutable exports (export let). Use const or a getter function instead.",
        },
        {
          selector: "PrivateIdentifier",
          message: "Use TypeScript's private keyword instead of # private fields.",
        },
      ],
